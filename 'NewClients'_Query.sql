/* This query pulls client name, email, mailing information, and lifetime order count for clients that have placed their first order within the past 90 days from the date the query is run.
 does not include deleted orders, clients not opted into mailing list, or clients with 'noemail' contained in their
 email address*/
